...
def run_prepare_campaign(
    campaign_id: str, prepare_generation: int, identity_generation: int,
):
    ...
    return _run("prepare_campaign", campaign_id, prepare_generation, identity_generation)
